...
namespace Rig_O_Meter
{
    public class Actuator : MyObject
    {
        ...
        public float Extension
        {
            ...
            private set { _extension = value; OnPropertyChanged(nameof(Extension)); }
        }
        float _utilisation;
        public float Utilisation
        {
            get { return _utilisation; }
            private set { _utilisation = value; OnPropertyChanged(nameof(Utilisation)); }
        }
